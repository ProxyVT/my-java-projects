...
public class CakeSimulator {
	...
	public static String randomSurprise() {
		...
		switch (number) {
		case 1: surprise = FIRST_SURPRISE; break;
		case 2: surprise = SECOND_SURPRISE; break;
		case 3: surprise = THIRD_SURPRISE; break;
		case 4: surprise = FOURTH_SURPRISE; break;
		case 5: surprise = FIFTH_SURPRISE; break;
		case 6: surprise = SIXTH_SURPRISE; break;
		}
