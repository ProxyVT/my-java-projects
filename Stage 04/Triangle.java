...
public class Triangle {
	...
	public static String resultTriangle() {
		...
		System.out.println("Enter coordinates x1 and y1 of the triangle: ");
		double x1 = scanner.nextDouble();
		double y1 = scanner.nextDouble();
		System.out.println("Enter coordinates x2 and y2 of the triangle: ");
		double x2 = scanner.nextDouble();
		double y2 = scanner.nextDouble();
		System.out.println("Enter coordinates x3 and y3 of the triangle: ");
